...
topics: []
image: 'img/unnamed-chunk-2-1.png'
---
...
<div id="aquire-and-clean-data" class="section level1">
<h1>Aquire and Clean Data</h1>
...
<pre class="sourceCode r"><code># correlate deaths and cases by state
library(tidyverse)
...
<th align="left">location_type</th>
<th align="left">location_code</th>
<th align="left">location_code_type</th>
...
<tbody>
<tr class="odd">
<td align="left">2020-11-28</td>
<td align="left">Alabama</td>
<td align="left">state</td>
<td align="left">01</td>
<td align="left">fips_code</td>
<td align="left">cases_total</td>
<td align="right">244993</td>
</tr>
<tr class="even">
<td align="left">2020-11-28</td>
<td align="left">Alabama</td>
...
<pre class="sourceCode r"><code># Create rolling average changes
# pivot wider
...
<td align="right">53906</td>
<td align="right">784</td>
<td align="right">6857.571</td>
<td align="right">95.28571</td>
</tr>
<tr class="even">
<td align="left">2020-03-25</td>
<td align="right">68540</td>
<td align="right">1053</td>
<td align="right">8599.714</td>
<td align="right">127.28571</td>
</tr>
<tr class="odd">
<td align="left">2020-03-26</td>
<td align="right">85521</td>
<td align="right">1352</td>
<td align="right">10448.571</td>
<td align="right">162.85714</td>
</tr>
<tr class="even">
<td align="left">2020-03-27</td>
<td align="right">102847</td>
<td align="right">1769</td>
<td align="right">12121.286</td>
<td align="right">213.14286</td>
</tr>
<tr class="odd">
<td align="left">2020-03-28</td>
<td align="right">123907</td>
<td align="right">2299</td>
<td align="right">14199.143</td>
<td align="right">277.00000</td>
</tr>
<tr class="even">
<td align="left">2020-03-29</td>
<td align="right">142426</td>
<td align="right">2717</td>
<td align="right">15625.714</td>
<td align="right">322.85714</td>
</tr>
<tr class="odd">
<td align="left">2020-03-30</td>
<td align="right">163893</td>
<td align="right">3367</td>
<td align="right">17202.429</td>
<td align="right">398.42857</td>
</tr>
<tr class="even">
<td align="left">2020-03-31</td>
<td align="right">188320</td>
<td align="right">4302</td>
<td align="right">19202.000</td>
<td align="right">502.57143</td>
</tr>
<tr class="odd">
<td align="left">2020-04-01</td>
<td align="right">215238</td>
<td align="right">5321</td>
<td align="right">20956.857</td>
<td align="right">609.71429</td>
</tr>
<tr class="even">
<td align="left">2020-04-02</td>
<td align="right">244948</td>
<td align="right">6537</td>
<td align="right">22775.286</td>
<td align="right">740.71429</td>
</tr>
<tr class="odd">
<td align="left">2020-04-03</td>
<td align="right">277264</td>
<td align="right">7927</td>
<td align="right">24916.714</td>
<td align="right">879.71429</td>
</tr>
</tbody>
</table>
</div>
...
<p>We might be tempted to simply regress deaths vs. cases but a scatter plot shows us that would not be satisfactory. As it turns out, the relationship of cases and deaths is strongly conditioned on date. This reflects the declining mortality rate as we have come to better understand the disease.</p>
<pre class="sourceCode r"><code># does a simple scatterplot tell us anything 
...
us %&gt;% 
  ...
  labs(title =  &quot;U.S. Cases vs. Deaths&quot;,
       ...
       x = &quot;Date&quot;)</code></pre>
<p><img src="img/unnamed-chunk-2-1.png" width="672" />
...
<pre class="sourceCode r"><code># passage of time affects deaths more than cases
...
<div id="build-some-models" class="section level1">
<h1>Build Some Models</h1>
...
<pre class="sourceCode r"><code>#create columns for deaths led 0 to 40 days ahead
max_lead &lt;- 40
us_lags &lt;- us %&gt;%
  # create lags by day
...
<th align="right">cases_7day</th>
<th align="right">deaths_7day</th>
<th align="right">deaths_7day_lead0</th>
<th align="right">deaths_7day_lead1</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td align="right">24513</td>
<td align="right">360</td>
<td align="right">0.000</td>
<td align="right">0.00000</td>
<td align="right">0.00000</td>
<td align="right">55.57143</td>
</tr>
<tr class="even">
<td align="left">2020-03-22</td>
<td align="right">33046</td>
<td align="right">457</td>
<td align="right">4204.714</td>
<td align="right">55.57143</td>
<td align="right">55.57143</td>
<td align="right">69.57143</td>
</tr>
<tr class="odd">
<td align="left">2020-03-23</td>
<td align="right">43476</td>
<td align="right">578</td>
<td align="right">5565.143</td>
<td align="right">69.57143</td>
<td align="right">69.57143</td>
<td align="right">95.28571</td>
</tr>
...
<pre class="sourceCode r"><code># make long form to nest
...
<pre class="sourceCode r"><code># Show model fit by lead time
...
<p><img src="img/unnamed-chunk-6-1.png" width="672" />
We can have some confidence that we are not overfitting the <code>date</code> variable because the significance of the case count remains. With a high enough degree polynomial on the <code>date</code> variable, cases would vanish in importance.</p>
<pre class="sourceCode r"><code>best_fit$model[[1]] %&gt;% tidy()</code></pre>
...
<div id="declining-mortality-rate" class="section level1">
<h1>Declining Mortality Rate</h1>
...
<pre class="sourceCode r"><code>fatality &lt;- best_fit$data[[1]] %&gt;% 
  filter(cases_7day &gt; 0) %&gt;%
...
<div id="state-level-analysis" class="section level1">
<h1>State-Level Analysis</h1>
...
us_states %&gt;% 
  ...
  labs(title =  &quot;U.S. Cases vs. Deaths&quot;,
       ...
       caption = &quot;Source: NY Times, Arthur Steinmetz&quot;,
       x = &quot;Date&quot;)</code></pre>
<p><img src="img/unnamed-chunk-10-1.png" width="576" /></p>
...
<div id="run-state-models" class="section level1">
<h1>Run State Models</h1>
...
<pre class="sourceCode r"><code># create lags
...
models_st %&gt;%
  ...
  labs(title = &quot;Best Fit Lead Time&quot;,
       caption = &quot;Source: NY Times, Arthur Steinmetz&quot;)</code></pre>
<p><img src="img/unnamed-chunk-11-1.png" width="576" /></p>
...
<pre class="sourceCode r"><code># best fit lag by state
...
<pre class="sourceCode r"><code>best_fit_st %&gt;% ggplot(aes(lead)) + 
...
<div id="validate-with-individual-case-data-from-ohio" class="section level1">
<h1>Validate with Individual Case Data from Ohio</h1>
...
<pre class="sourceCode r"><code># source: https://coronavirus.ohio.gov/static/dashboards/COVIDSummaryData.csv
...
<pre class="sourceCode r"><code># create rolling average function
...
We clearly see the numbers line up almost exactly but the Ohio data runs about 4 days ahead of the NY Times data.</p>
...
<pre class="sourceCode r"><code># aggregate the data to weekly
ohio &lt;- ohio %&gt;% 
...
onset_to_death %&gt;% ggplot(aes(date,death_count_sum)) + geom_col() +
    labs(title =  &quot;Ohio Weekly Deaths&quot;,
       ...
       y = &quot;Deaths&quot;)</code></pre>
<p><img src="img/unnamed-chunk-17-1.png" width="672" />
When we measure the average lag, we find that it has been fairly stable over time in Ohio. Unfortunately, it differs substantially from our proxy model using untracked cases.</p>
<pre class="sourceCode r"><code># helper function to annotate plots 
...
<p><img src="img/unnamed-chunk-18-1.png" width="672" />
...
<pre class="sourceCode r"><code>ohio_fatality_rate &lt;- ohio %&gt;% 
  group_by(onset_date) %&gt;% 
