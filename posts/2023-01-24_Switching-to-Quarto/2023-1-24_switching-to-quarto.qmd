...
7.  Change YAML header 'tags' to 'categories.'
8.  Search/Replace all instances of \`class="r"\` to \`class="sourceCode r"\`.
9.  Fix path names of any image files to point to the 'img' folder.
10. Copy rmarkdown-libs folder with any HTML widgets. Plotly Javascript will be be here.
